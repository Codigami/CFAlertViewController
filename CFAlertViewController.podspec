#
#  Be sure to run `pod spec lint CFAlertViewController.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC "CFAlertViewController is a library that helps you display and customise alerts and action sheets on iPad and iPhone. It offers screen rotation as well as an adaptive UI support. CFAlertViewController’s functionality is almost similar to the native UIAlertController."
                   DESC
  ...
  s.source       = { :git => "https://github.com/Codigami/CFAlertViewController.git", :tag => "v1.0.10" }
